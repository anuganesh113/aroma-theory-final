    ...
    <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <motion.img 
          ...
          src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=80&w=2000&h=1200" 
          alt="Culinary art" 
      ...
      <div className="relative z-10 text-center px-6 md:px-12 mt-20">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-4">
             ...
             <h2 className="text-[10px] uppercase tracking-[0.3em] text-gold font-semibold">Visual Story</h2>
             <div className="w-12 h-[1px] bg-gold" />
          </div>
