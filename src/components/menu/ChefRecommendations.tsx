      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <motion.div 
            ...
            className="relative h-[500px] lg:h-[700px] rounded-[32px] overflow-hidden group"
          >
            <img 
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl lg:text-6xl font-serif mb-4 leading-[1.1] tracking-tight text-white">
              Chef's Signature Creations
            </h3>
            
            <div className="mt-8 border-t border-white/10 pt-8">
              <h4 className="font-serif text-3xl mb-2 text-gold">Dry-Aged Crown Roast Duck</h4>
