...
export function SeasonalSpecials() {
  return (
    <section id="specials" className="py-24 bg-charcoal text-cream relative overflow-hidden scroll-mt-20">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-2xl">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl lg:text-7xl font-serif mb-6 leading-[1.1] tracking-tight">
              Autumn Harvest <br /> Collection
            </h3>
            
            <p className="text-cream/70 font-light text-base md:text-lg leading-relaxed mb-10 max-w-lg">
